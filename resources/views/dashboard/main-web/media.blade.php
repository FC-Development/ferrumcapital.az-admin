...
@section('content')
    <div class="row justify-content-between ml-0 mr-0">
        ...
        <button class="btn btn-primary addNewMediaBTN" type="button">
    ...
    <div class="modal fade hide pr-0" id="NewMediaModal" tabindex="-1" aria-modal="false" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form class="modal-body" id="MediaForm" enctype=multipart/form-data>
                    @csrf
...
{{--                                image</span>--}}
{{--                            <div class="custom-file mt-8">--}}
{{--                                <input type="file" class="custom-file-input" id="include_image" name="include_image">--}}
{{--                                <label for="image" class="custom-file-label">Seçim edin</label>--}}
{{--                            </div>--}}
{{--                        </div>--}}
                        <div class="col-md-3 mb-3">
                            <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Preview</label>
                            <input type="text" class="form-control border border-light" id="tips_text" name="tips_text"
                                minlength="2" required>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Media
                                sektor</label>
                            <input type="text" class="form-control border border-light" id="media_sector"
                                name="media_sector" minlength="2" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Meta description</label>
                        ...
                        <div class="col-md-3 mb-3">
                            <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Media
                                Language</label>
                            <select type="text" class="form-control border border-light" id="media_lang" name="media_lang"
                                minlength="2" required>
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Media
                                body</label>
                            <textarea type="text" class="form-control border border-light" id="media_body" name="media_body" minlength="2" required></textarea>
                        </div>
                    </div>
    ...
    <div class="modal fade hide" id="mediaStatusModal" tabindex="-1" aria-modal="false" role="dialog">
                    ...
                    <form id="UpdateMedia" enctype=multipart/form-data>
                        ...
                        <div class="row" id="blog">
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Media
                                    body</label>
                                <textarea type="text" class="form-control border border-light" id="media_body_edit" name="media_body_edit" minlength="2"
                                    required></textarea>
                            </div>
