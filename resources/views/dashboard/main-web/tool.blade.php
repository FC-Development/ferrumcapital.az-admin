...
@section('content')
    <div class="row justify-content-between ml-0 mr-0">
        ...
        <button class="btn btn-primary addNewToolBTN" type="button">
    ...
    <div id="gridtool"></div>
    <div class="modal fade hide pr-0" id="NewToolModal" tabindex="-1" aria-modal="false" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form class="modal-body" id="ToolForm" enctype=multipart/form-data>
                    @csrf
    ...
    <div class="modal fade hide" id="toolStatusModal" tabindex="-1" aria-modal="false" role="dialog">
    ...
    <div class="modal fade hide pr-0" id="UpdateToolModal" tabindex="-1" aria-modal="false" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="modal-body" id="UpdateTool" enctype=multipart/form-data>
                    @csrf
