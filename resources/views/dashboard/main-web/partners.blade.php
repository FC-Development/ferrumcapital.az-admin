        ...
        <div class="modal-content">
            ...
            <form class="modal-body" id="BrendForm" enctype=multipart/form-data>
                ...
                <div class="row" id="blog">
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Telefon</label>
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Instagram</label>
                        <input type="url" class="form-control border border-light" id="ig" name="ig" minlength="2">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Facebook</label>
                        <input type="text" class="form-control border border-light" id="fb" name="fb" minlength="2">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Vebsayt</label>
                        <input type="url" class="form-control border border-light" id="website" name="website" minlength="2">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Kateqoriya</label>
                        <select name="category" class="form-control brand_sector">
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Status</label>
                        <select name="status" class="form-control brand_sector">
                            <option value="test">Aktiv</option>
                            <option value="test">Deaktiv</option>
                        </select>

                    </div>
                    <div class="col-md-12 mb-3">
                        <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Haqqında</label>
                        <textarea type="text" class="form-control border border-light" id="about" name="blog_body" minlength="2" required></textarea>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form class="modal-body" id="BrendUpdate" enctype=multipart/form-data>
                ...
                <div class="row" id="blog">
                    <div class="col-md-3 mb-3">
                        <label for="title" class="f-sm form-label font-weight-bold text-muted text-uppercase">Name</label>
                        <input type="text" class="form-control border border-light" id="name" name="name" minlength="2" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <span class="f-sm form-label font-weight-bold text-muted text-uppercase">Logo</span>
                        <div class="custom-file mt-8">
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Website</label>
                        <input type="url" class="form-control border border-light" id="website" name="website" minlength="2">
                    </div>
                    <div class="col-md-3 mb-3">
