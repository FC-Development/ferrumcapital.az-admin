...
@section('content')
    ...
    <div id="gridBfStats"></div>
    <div class="modal fade hide pr-0" id="NewBfStatsModal" tabindex="-1" aria-modal="false" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form class="modal-body" id="BfStatsForm" enctype=multipart/form-data>
                    @csrf
    ...
    <div class="modal fade hide pr-0" id="BfStatsModal" tabindex="-1" aria-modal="false" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
