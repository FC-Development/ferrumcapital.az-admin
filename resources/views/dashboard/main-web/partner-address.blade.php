...
<div class="row justify-content-between ml-0 mr-0">
    <div class="header-title">
        <h4 class="card-title">Partnyor ünvanları</h4>
    </div>
            ...
            <form class="modal-body" id="BlogForm" enctype=multipart/form-data>
                ...
                <div class="row" id="">
                    <div class="col-12 mb-3">
                        <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Partnyorlar</label>
                        <select type="text" class="form-control border border-light" id="" name="" minlength="2" required>
                            <option value="">OtoMall</option>
                            <option value="">Autopegasus</option>
                        </select>
                    </div>
                    <div class="col-12 partnerAddressBox">
