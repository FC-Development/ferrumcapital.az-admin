...
@section('content')
    <div class="row justify-content-between ml-0 mr-0">
        <div class="header-title">
            <h4 class="card-title">Testimonial Customer</h4>
        </div>
        <button class="btn btn-primary addNewTestimnlCstmrBTN" type="button">
    ...
    <div id="gridtestimnlCstmr"></div>
    <div class="modal fade hide pr-0" id="NewTestimnlCstmrModal" tabindex="-1" aria-modal="false" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form class="modal-body" id="TestimnlCstmrForm" enctype=multipart/form-data>
                    @csrf
                    ...
                    <div class="row" id="testimnl">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Text Az</label>
    ...
    <div class="modal fade hide pr-0" id="TestimnlCstmrModal" tabindex="-1" aria-modal="false" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="modal-body" id="UpdateTestimnlCstmr" enctype=multipart/form-data>
                    @csrf
