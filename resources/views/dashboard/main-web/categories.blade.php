            ...
            <div class="modal-content">
                ...
                <form class="modal-body" id="BlogForm" enctype=multipart/form-data>
                    ...
                    <div class="row" id="blog">
                        <div class="col mb-3">
                            <label for="title"
                                class="f-sm form-label font-weight-bold text-muted text-uppercase">Ad</label>
                        ...
                        <div class="col-md-3 mb-3">
                            <label for="" class="f-sm form-label font-weight-bold text-muted text-uppercase">Blog
                                Dili</label>
                            <select type="text" class="form-control border border-light" id="blog_lang" name="blog_lang"
                                minlength="2" required>
