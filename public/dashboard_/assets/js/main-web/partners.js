...
makeSideBar();
let GetPartners = new gridjs.Grid({
    columns: [
    ...
    server: {
           url: "/dashboard/csapi/partners/get",
...
if (top.location.pathname === '/dashboard/partners') {
    GetPartners.render(document.getElementById("gridPartners"));
