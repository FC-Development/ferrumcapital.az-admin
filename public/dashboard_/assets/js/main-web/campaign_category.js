...
makeSideBar();
let GetCampaignCategory = new gridjs.Grid({
    columns: [
    ...
    server: {
           url: "/dashboard/csapi/campaign_category/get",
...
if (top.location.pathname === '/dashboard/campaign_category') {
    GetCampaignCategory.render(document.getElementById("gridCampaignCategory"));
...
$("#BlogForm").submit(function (e) {
    ...
    $.ajax({
           ...
           success: function () {
                  ...
                  GetCampaignCategory.forceRender();
