...
makeSideBar();
let GetPartnerAddress = new gridjs.Grid({
    columns: [
    ...
    server: {
           url: "/dashboard/csapi/partner_address/get",
...
if (top.location.pathname === '/dashboard/partner_address') {
    GetPartnerAddress.render(document.getElementById("gridPartnerAddress"));
