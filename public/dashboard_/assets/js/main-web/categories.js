...
makeSideBar();
let GetCategories = new gridjs.Grid({
    columns: [
    ...
    server: {
           url: "/dashboard/csapi/categories/get",
...
if (top.location.pathname === '/dashboard/categories') {
    GetCategories.render(document.getElementById("gridCategories"));
