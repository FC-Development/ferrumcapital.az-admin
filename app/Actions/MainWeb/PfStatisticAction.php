...
class PfStatisticAction extends AdminMethods
{
       public function getData()
       {
              $response = Http::withHeaders(
                 ...
                 ->get("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/pf_statistic");
       ...
       public function postData(Request $request)
       {
              $response= Http::withHeaders(
                     ['xc-auth' => env('NOCODB_AUTH')]
              )->post("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/pf_statistic",[
       ...
       public function findData(Request $request)
       {
              ...
              ->get("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/pf_statistic/?where=(uniq_id,like,".$uniq_id.")");
       ...
       public function deleteData(Request $request)
       {
              ...
              $response=Http::withHeaders(
                     ['xc-auth' => env('NOCODB_AUTH')]
              )->delete("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/pf_statistic/".$id);
       ...
       public function updateData(Request $request)
       {
              ...
              $response = Http::withHeaders(
                     ['xc-auth' => env("NOCODB_AUTH")] 
              )->put("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/pf_statistic/$id",[
                     'header' => json_encode(['az'=> $request->input('header_az'),'en' => $request->input('header_en')]) ,
                     'value' => $request->input('value'),
                     'category' => \json_encode(['az'=>$request->input('category_az'),'en' => $request->input('category_en')]) ,
              ]);
