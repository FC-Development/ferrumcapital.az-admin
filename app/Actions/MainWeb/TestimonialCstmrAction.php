...
class TestimonialCstmrAction extends AdminMethods
{
       public function getData()
       {
              $response = Http::withHeaders(
                 ...
                 ->get("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/testimonial_customer");
       ...
       public function postData(Request $request)
       {
              $response= Http::withHeaders(
                     ['xc-auth' => env('NOCODB_AUTH')]
              )->post("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/testimonial_customer",[
       ...
       public function updateData(Request $request)
       {
              ...
              $get_data = Http::withHeaders([
                 ...
                 ])->get("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/testimonial_customer/?where=(uniq_id,like,".$uniq_id.")");
              $id = $get_data[0]['id'];
              $response = Http::withHeaders(
                     ['xc-auth' => env("NOCODB_AUTH")] 
              )->put("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/testimonial_customer/$id",[
                     'fullname' => \json_encode(['az'=>$request->input('fullname_az'),'en' => $request->input('fullname_en')]),
                     'text' => \json_encode(['az' => $request->input('text_az'),'en' =>$request->input('text_en') ])
              ]);
       ...
       public function updateDataStatus(Request $request, $id)
       {
              $tmp_arr_ = array(
                 ...
                 $response = Http::withHeaders([
                     'xc-auth' => \env('NOCODB_AUTH'),
                     'Content-Type' => 'application/json'
                 ])->get("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/testimonial_customer/?where=(uniq_id,like,".$id.")");
                 $last_res = Http::withHeaders([
                     'xc-auth' => env('NOCODB_AUTH'),
                     'Content-Type' => 'application/json'
                 ])->put('http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/testimonial_customer/'.$response[0]['id'], [
       ...
       public function deleteData(Request $request)
       {
              ...
              $response=Http::withHeaders(
                     ['xc-auth' => env('NOCODB_AUTH')]
              )->delete("http://172.16.10.132:3574/nc/ferrumcapital_main_a5um/api/v1/testimonial_customer/".$id);
