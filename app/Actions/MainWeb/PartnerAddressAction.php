...
class PartnerAddressAction extends AdminMethods
{
       protected $time;
       public function getData()
       {
              $response = PartnerAddress::all();
              echo ($response);
              return $response;
       ...
       {
              $response= PartnerAddress::create([
       ...
       public function findData(Request $request)
       {
              ...
              $get_data = PartnerAddress::where('uniq_id',$uniq_id)->get();
              return $get_data;
       }
       public function deleteData(Request $request)
       {
              ...
              $response= PartnerAddress::where('uniq_id',$uniq_id)->delete();
              return $response;
       }
       public function updateDataStatus(Request $request,$id)
       {
              $tmp_arr_ = array(
                 ...
                 $last_res = PartnerAddress::where('uniq_id',$id)->update([
       ...
       public function updateData(Request $request)
       {
              ...
              $response = PartnerAddress::where('uniq_id',$uniq_id)->update([
                     'title' => $request['title'],
