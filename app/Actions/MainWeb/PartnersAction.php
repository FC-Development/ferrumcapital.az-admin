...
class PartnersAction extends AdminMethods
{
       protected $time;
       ...
       public function findData(Request $request)
       {
              ...
              $get_data = Partners::where('uniq_id',$uniq_id)->get();
              return $get_data;
       }
       public function deleteData(Request $request)
       {
              ...
              $response= Partners::where('uniq_id',$uniq_id)->delete();
              return $response;
       }
       public function updateDataStatus(Request $request,$id)
       {
              $tmp_arr_ = array(
                 ...
                 $last_res = Partners::where('uniq_id',$id)->update([
       ...
       public function updateData(Request $request)
       {
              ...
              $response = Partners::where('uniq_id',$uniq_id)->update([
                     'title' => $request['title'],
